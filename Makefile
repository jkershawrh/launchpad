.PHONY: install test test-local lint catalog-artifacts artifact-registry security-threat-model audit-integrity-retention delivery-governance clean dev-backend dev-frontend dev-admin demo-test
