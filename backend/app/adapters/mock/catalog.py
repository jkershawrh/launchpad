...
SEED_CATALOG: List[Dict] = [
    ...
    },
    {
        ...
        "default_quota_profile": "standard",
        "default_ttl": "4h",
        "provisioner_refs": ["helm-provisioner"],
        "validation_refs": ["pod-ready", "route-accessible"],
    ...
    },
    {
        ...
        "default_quota_profile": "standard",
        "default_ttl": "4h",
        "provisioner_refs": ["kustomize-provisioner"],
        "validation_refs": ["pod-ready", "inference-health"],
        "handoff_template": "quickstart-handoff",
        "supported_branding": ["redhat-intel-default", "intel-internal"],
        "metadata": {
            "official_quickstart": True,
    ...
    {
        "catalog_item_id": "qs-data-governance",
        "display_name": "Data Governance — Official AI Quickstart",
        "description": "Official Red Hat Summit AI Quickstart. Data governance pipeline with policy enforcement, classification, and compliance monitoring for AI workloads.",
        "category": CatalogCategory.QUICK_START,
        "version": "1.0.0",
        "status": CatalogStatus.ACTIVE,
        "required_capabilities": ["openshift", "model_endpoint"],
        ...
        "default_quota_profile": "standard",
        "default_ttl": "4h",
        "provisioner_refs": ["mock-provisioner"],
        "validation_refs": ["pod-ready", "route-accessible"],
        "handoff_template": "quickstart-handoff",
        "supported_branding": ["redhat-intel-default", "intel-internal"],
        "metadata": {
            "official_quickstart": True,
            "quickstart_source": "rh-ai-quickstart/data-governance",
            "maas_compatible": True,
        },
    },
    {
        "catalog_item_id": "qs-ppe-compliance",
        "display_name": "PPE Compliance Monitor — Official AI Quickstart",
        "description": "Official Red Hat Summit AI Quickstart. Multimodal PPE compliance monitoring with computer vision and LLM-powered analysis. Uses OpenVINO for edge inference.",
        "category": CatalogCategory.QUICK_START,
        "version": "1.0.0",
        "status": CatalogStatus.ACTIVE,
        "required_capabilities": ["openshift", "model_endpoint"],
        ...
        "metadata": {
            "official_quickstart": True,
            "quickstart_source": "rh-ai-quickstart/ppe-compliance-monitor",
            "maas_compatible": True,
        },
    },
    {
        "catalog_item_id": "qs-product-recommendation",
        "display_name": "Product Recommendation — Official AI Quickstart",
        "description": "Official Red Hat Summit AI Quickstart. AI-powered product recommendation engine with embeddings, vector search, and personalized suggestions.",
        "category": CatalogCategory.QUICK_START,
        "version": "1.0.0",
        "status": CatalogStatus.ACTIVE,
        "required_capabilities": ["openshift", "model_endpoint"],
        ...
        "metadata": {
            "official_quickstart": True,
            "quickstart_source": "rh-ai-quickstart/product-recommendation",
            "maas_compatible": True,
        },
    },
    {
        "catalog_item_id": "qs-it-self-service",
        "display_name": "IT Self-Service — Official AI Quickstart",
        "description": "Official Red Hat Summit AI Quickstart. AI-powered IT self-service portal with ticket classification, knowledge base search, and automated remediation.",
        "category": CatalogCategory.QUICK_START,
        "version": "1.0.0",
        "status": CatalogStatus.ACTIVE,
        "required_capabilities": ["openshift", "model_endpoint"],
        ...
        "metadata": {
            "official_quickstart": True,
            "quickstart_source": "rh-ai-quickstart/it-self-service",
            "maas_compatible": True,
        },
    },
]
