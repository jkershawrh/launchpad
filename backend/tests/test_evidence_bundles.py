...
class TestEvidenceBundles:
    ...
    @patch("app.integrations.event_publisher.STARGATE_API_URL", "https://stargate.test")
    @patch("app.integrations.event_publisher.urllib.request.urlopen")
    ...
    @patch("app.integrations.event_publisher.STARGATE_API_URL", "")
